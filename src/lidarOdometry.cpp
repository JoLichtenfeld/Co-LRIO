...
private:
    ...
    rclcpp::Subscription<co_lrio::msg::OptimizationResponse>::SharedPtr sub_optimization_response;
    rclcpp::Subscription<co_lrio::msg::LoopClosure>::SharedPtr sub_loop_closure;
    /* *********************************** */
